...
export const WhatsAppIcon = (
  <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12.05 0C5.495 0 .16 5.335.16 11.891c0 2.096.547 4.142 1.588 5.945L.057 24l6.304-1.654c1.737.949 3.696 1.451 5.69 1.451h.005c6.554 0 11.89-5.335 11.89-11.891 0-3.178-1.237-6.163-3.484-8.41A11.82 11.82 0 0 0 12.05 0Zm0 21.785h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.981.999-3.648-.235-.374a9.86 9.86 0 0 1-1.512-5.26c0-5.45 4.436-9.884 9.889-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c0 5.45-4.435 9.885-9.885 9.885Z" />
  </svg>
);
